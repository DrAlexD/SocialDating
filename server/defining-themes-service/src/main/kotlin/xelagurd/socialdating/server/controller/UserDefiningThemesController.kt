...
class UserDefiningThemesController(
    ...
    @PostMapping
    fun addUserDefiningTheme(@RequestBody userDefiningTheme: UserDefiningTheme): UserDefiningTheme {
        return userDefiningThemesService.addUserDefiningTheme(userDefiningTheme)
    }
}